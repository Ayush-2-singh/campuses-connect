...
export default function NotificationsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '48px 20px', textAlign: 'center' }}>
      ...
      <h2 style={{ fontSize: 18, fontWeight: 700, color: 'var(--text-primary)', margin: '0 0 6px' }}>Notifications couldn&apos;t load</h2>
      <p style={{ fontSize: 13, color: 'var(--text-muted)', margin: '0 0 18px' }}>
        Something went wrong loading your notifications. Try again.
      </p>
