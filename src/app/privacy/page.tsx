  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={textStyle}>
          By using Campus Connect, you acknowledge that you have read and understood this Privacy Policy.
        </p>

        {/* Section 1 */}
        <div style={sectionStyle}>
          <h2 style={headingStyle}>1. Information We Collect</h2>
          <p style={textStyle}>We may collect different types of information depending on how you use Campus Connect.</p>
          ...
          <p style={textStyle}>We use this information to create and maintain your Campus Connect account. We do not receive your third-party account password.</p>

          <h3 style={subHeadingStyle}>1.3 Automatically Collected Information</h3>
          <p style={textStyle}>When you use Campus Connect, certain technical information may be collected automatically, including:</p>
          <ul style={listStyle}>
            <li>IP address</li>
            <li>Browser type</li>
            <li>Device type</li>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>Campus Connect may provide games, quizzes, competitions, rankings, or other interactive features.</p>
        ...
        <div style={sectionStyle}>
          ...
          <ul style={listStyle}>
            <li>Provide and operate Campus Connect</li>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>Some information you provide may be visible to other Campus Connect users depending on the feature and your settings.</p>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>Campus Connect may use cookies, local storage, session storage, and similar technologies to:</p>
          <ul style={listStyle}>
          ...
          <p style={textStyle}>You can control cookies through your browser settings. However, disabling certain cookies or storage technologies may cause some features of Campus Connect to stop working correctly.</p>
        </div>

        {/* Section 6 */}
        <div style={sectionStyle}>
          <h2 style={headingStyle}>6. Third-Party Services</h2>
          <p style={textStyle}>Campus Connect may use third-party services to provide infrastructure, authentication, analytics, hosting, databases, communication, security, or other functionality.</p>
          ...
          <p style={textStyle}>We encourage users to review the privacy policies of third-party services they use to access Campus Connect.</p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>You may request deletion of your Campus Connect account and associated personal information by contacting us through the support/contact mechanism provided on the website.</p>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>Campus Connect is intended for users who are legally permitted to use the Service under applicable law.</p>
          <p style={textStyle}>We do not knowingly collect personal information from children where such collection is prohibited by applicable law. If you believe that a child has provided personal information to Campus Connect in violation of applicable requirements, please contact us so that we can review and take appropriate action.</p>
        </div>

        {/* Section 12 */}
        <div style={sectionStyle}>
          <h2 style={headingStyle}>12. User-Generated Content</h2>
          <p style={textStyle}>Campus Connect may allow users to create, upload, publish, or share content. You should carefully consider what information you include in publicly accessible content.</p>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>Campus Connect may contain links to third-party websites, services, or applications. We do not control those third parties and are not responsible for their privacy practices.</p>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>Your information may be processed or stored on servers located outside your state, region, or country, depending on the infrastructure and service providers used by Campus Connect.</p>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>For material changes, we may provide additional notice where required by applicable law. Your continued use of Campus Connect after an updated Privacy Policy becomes effective means that you acknowledge the updated policy.</p>
        </div>

        {/* Section 17 */}
        <div style={sectionStyle}>
          <h2 style={headingStyle}>17. Contact Us</h2>
          <p style={textStyle}>If you have questions, concerns, or requests regarding this Privacy Policy or your personal information, please contact us through the contact/support information provided on Campus Connect.</p>
          ...
          <p style={textStyle}>Privacy inquiries: Contact the Campus Connect support team through the website.</p>
        </div>

        {/* Section 18 */}
        <div style={sectionStyle}>
          <h2 style={headingStyle}>18. Important Notice</h2>
          <p style={textStyle}>This Privacy Policy describes Campus Connect&apos;s general privacy practices and is intended to provide transparency about how information may be handled.</p>
