              ...
              <div>
                ...
                >
                  ...
                  <StatCard
                    emoji="🆕"
                    label="Today"
                    value={overview.users.daily_new}
                    sub="new"
                  ...
                  <StatCard
                    emoji="📅"
                    label="This Week"
                    value={overview.users.weekly_new}
                    sub="new"
                    color="var(--accent)"
                  />
                  <StatCard
                    emoji="📆"
                    label="This Month"
                    value={overview.users.monthly_new}
                    sub="new"
                ...
                >
                  ...
                  <StatCard
                    emoji="💬"
                    label="Comments"
                    value={overview.engagement.total_comments}
                    color="var(--success-text)"
                  />
                  <StatCard
                    emoji="❤️"
                    label="Reactions"
                    value={overview.engagement.total_reactions}
                    color="var(--danger)"
                  />
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: 8 }}>
                  ...
                  <StatCard
                    emoji="🛡️"
                    label="Mod Queue"
                    value={overview.platform.open_mod_items}
                    color={overview.platform.open_mod_items > 0 ? 'var(--danger)' : 'var(--success-text)'}
                  />
                </div>
              </div>
            )}
            ...
            {activeTab === 'growth' && growthChartData && (
              <div>
                ...
                >
                  ...
                  <BarChart
                    data={growthChartData.users}
                    labels={growthChartData.labels}
                    colors={growthChartData.users.map((v: number) => (v > 0 ? 'var(--accent)' : 'var(--bg-secondary)'))}
                  />
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <BarChart
                    data={growthChartData.posts}
                    labels={growthChartData.labels}
                    colors={growthChartData.posts.map((v: number) =>
                      v > 0 ? 'var(--success-text)' : 'var(--bg-secondary)'
                    )}
                  />
                </div>
                {/* Growth summary */}
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, marginTop: 16 }}>
                  ...
                  >
                    <p style={{ fontSize: 24, fontWeight: 800, color: 'var(--accent)', margin: 0 }}>
                      {growthChartData.users.reduce((a: number, b: number) => a + b, 0)}
                    </p>
                  ...
                  >
                    <p style={{ fontSize: 24, fontWeight: 800, color: 'var(--success-text)', margin: 0 }}>
                      {growthChartData.posts.reduce((a: number, b: number) => a + b, 0)}
                    </p>
                  ...
                  >
                    <p style={{ fontSize: 24, fontWeight: 800, color: 'var(--orange-text)', margin: 0 }}>
                      {growthChartData.users.length > 0
                        ? Math.round(growthChartData.users.reduce((a: number, b: number) => a + b, 0) / 30)
                        : 0}
                    </p>
                        ...
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <p style={{ fontSize: 11, color: 'var(--text-muted)', margin: 0 }}>
                              by @{post.author?.username || '—'} · {post.post_type} ·{' '}
                        ...
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            <div style={{ flex: 1 }}>
                              ...
                              {/* Progress bar */}
                              <div
                                style={{ height: 4, borderRadius: 2, background: 'var(--bg-secondary)', marginTop: 8 }}
                              >
                                <div
                                  style={{
                                    height: '100%',
                                    ...
                                    width: `${((c.user_count || 0) / maxUsers) * 100}%`,
