/* Connect to Campus enhanced service worker — offline-first for static pages,
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(self.registration.showNotification(data.title || 'Connect to Campus', options))
})
...
<title>Connect to Campus — Offline</title>
...
<p>Connect to Campus needs internet for most features.<br>Check your connection and try again.</p>
